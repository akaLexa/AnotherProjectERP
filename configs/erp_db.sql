--
-- Script date 04.02.2017 14:08:15
...
--
-- Definition for procedure sp_StartTaskPlan
--
...
MODIFIES SQL DATA
  ...
  BEGIN
    ...
    read_loop:
    LOOP
      FETCH cu_Work INTO tempTask; -- , parentTask;
      IF done THEN
        LEAVE read_loop;
      END IF;
...
INSERT INTO tbl_tasks VALUES
  (1, 'Задача 1', 1, 1, 1, NULL, 2, NULL, '2016-12-23 10:20:32', '2017-02-04 00:00:00', '2017-02-04 14:05:39', '2017-02-06 00:00:00', NULL, NULL, 2, 1, NULL, '0', '0', NULL, NULL, NULL),
  (3, 'Задача 3', 1, 1, 1, NULL, 2, NULL, '2016-12-23 11:03:31', '2017-02-04 00:00:00', '2017-02-04 14:05:39', '2017-02-07 00:00:00', NULL, NULL, 3, 1, 6, '2', '0', NULL, NULL, NULL),
  (6, 'тест', 1, 1, 1, NULL, 2, NULL, '2016-12-24 17:41:13', '2017-02-04 00:00:00', '2017-02-04 14:05:39', '2017-02-09 00:00:00', NULL, NULL, 5, 1, 1, '2', '1', NULL, NULL, NULL),
  ...
  (10, 'еще 1 тестовая', 5, 1, 1, NULL, 2, 'еще 1 тестовая задача', '2017-02-04 10:22:02', '2017-02-07 00:00:00', NULL, '2017-02-08 00:00:00', NULL, NULL, 1, 2, 11, '2', '1', NULL, NULL, NULL),
  (11, 'совсем совсем тестовая 123', 5, 1, 1, NULL, 2, 'малость баг что ли?', '2017-02-04 10:27:18', '2017-02-07 00:00:00', NULL, '2017-02-11 00:00:00', NULL, NULL, 4, 2, 3, '1', '1', NULL, NULL, NULL);
...
INSERT INTO tbl_project_stage VALUES
  (1, 1, 3, 1, '2016-12-15 11:18:59', '2017-01-29 15:11:42', NULL, '2016-12-15 11:18:59', '2016-12-19 11:18:59', '2017-02-04 14:05:39', 'Создан автоматически при заведении проекта Причина просрочки: тестовый запуск Причина просрочки: тестовый запуск Причина просрочки: поееехали! Причина просрочки: поееехали!', 1, NULL, 1, 1),
  (2, 1, 1, 1, '2016-12-21 16:01:04', '2017-02-04 14:05:39', '2017-02-04 00:00:00', NULL, '2017-02-10 00:00:00', NULL, NULL, 2, 1, 2, 6),
  (3, 1, 5, 1, '2016-12-21 16:03:28', NULL, '2017-02-10 00:00:00', NULL, '2017-02-11 00:00:00', NULL, NULL, 3, NULL, 3, 1);
